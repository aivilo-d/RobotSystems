...
class Picarx(object):
    ...
    @log_on_start(logging.DEBUG, 'set_cam_pan_angle starts')
    @log_on_error(logging.DEBUG, 'set_cam_pan_angle error') 
    @log_on_end(logging.DEBUG, 'set_cam_pan_angle ends')
    def set_cam_pan_angle(self, value):
        value = constrain(value, self.CAM_PAN_MIN, self.CAM_PAN_MAX)
        self.cam_pan.angle(-1*(value + -1*self.cam_pan_cali_val))

    @log_on_start(logging.DEBUG, 'set_cam_tilt_angle starts')
    @log_on_error(logging.DEBUG, 'set_cam_tilt_angle error') 
    @log_on_end(logging.DEBUG, 'set_cam_tilt_angle ends')
    ...
    @log_on_start(logging.DEBUG, 'set_power starts')
    @log_on_error(logging.DEBUG, 'set_power error') 
    @log_on_end(logging.DEBUG, 'set_power ends')
    ...
    @log_on_end(logging.DEBUG, 'backward ends')
    ...
    @log_on_start(logging.DEBUG, 'forward starts')
    @log_on_error(logging.DEBUG, 'forward error') 
    @log_on_end(logging.DEBUG, 'forward ends')
    ...
    @log_on_start(logging.DEBUG, 'stop starts')
    @log_on_error(logging.DEBUG, 'stop error') 
    @log_on_end(logging.DEBUG, 'stop ends') 
    def stop(self):
        '''
